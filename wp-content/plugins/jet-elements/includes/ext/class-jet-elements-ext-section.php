		...
		public function section_before_render( $obj ) {
			...
			if ( 'section' === $type ) {
				...
				if ( isset( $settings['jet_parallax_layout_list'] ) ) {
					$this->parallax_sections[ $data['id'] ] = method_exists( $obj, 'get_settings_for_display' ) ? $obj->get_settings_for_display( 'jet_parallax_layout_list' ) : $settings['jet_parallax_layout_list'];
				}
			}
		}
